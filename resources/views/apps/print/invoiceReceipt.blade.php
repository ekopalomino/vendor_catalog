...
<body>
					...
					<h2 align="right"><strong>INVOICE</strong></h2>
						<table style="height: 73px; border-color: #000000;" border="1" width="270">
							<tbody>
								...
								<tr>
								<td style="width: 148px;background:#4B77BE;color:#ffffff;font-size: 12px;">No PO</td>
								<td style="width: 148px;background:#4B77BE;color:#ffffff;">Termin Pembayaran</td>
								</tr>
								<tr>
								<td style="width: 148px;font-size: 10px;">{{$source->purchase_order}}</td>
								<td style="width: 148px;font-size: 10px;">{{ $source->Contacts->Terms->name }}</td>
								</tr>
								<tr>
								<td style="width: 148px;background:#4B77BE;color:#ffffff;font-size: 12px;">ID Supplier</td>
								</tr>
								<tr>
	...
	<table style="height: 9px;" width="540">
		<tbody>
			<tr>
				<td style="width: 172px;background:#4B77BE;color:#ffffff;font-size: 12px;">DI BAYARKAN KEPADA</td>
				<td style="width: 173px;">&nbsp;</td>
				<td style="width: 173px;background:#4B77BE;color:#ffffff;font-size: 12px;">BANK</td>
			</tr>
			<tr>
			<td style="width: 172px;">
				<table style="height: 72px;" width="174">
					<tbody>
						...
						<tr>
							<td style="width: 164px;font-size: 10px;">{{$source->Contacts->company}}</td>
						</tr>
						<tr>
			...
			<td style="width: 173px;">&nbsp;</td>
				<td style="width: 173px;">
					<table style="height: 79px;" width="175">
						<tbody>
							<tr>
							<td style="width: 164px;font-size: 10px;">{{ $source->Contacts->bank_name }}</td>
						</tr>
						<tr>
							<td style="width: 164px;font-size: 10px;">{{ $source->Contacts->account_no }}</td>
						</tr>
						</tbody>
					</table>
				</td>
