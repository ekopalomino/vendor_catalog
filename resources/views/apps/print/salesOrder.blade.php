					...
					<h2 align="right"><strong>SALES ORDER</strong></h2>
						<table style="height: 73px; border-color: #000000;" border="1" width="265">
							<tbody>
								...
								<td style="width: 148px;">{{date("d F Y",strtotime($sales->created_at)) }}</td>
								</tr>
								<tr>
								<td style="width: 148px;background:#4B77BE;color:#ffffff;">Termin Pembayaran</td>
								<td style="width: 148px;background:#4B77BE;color:#ffffff;">Tgl Pengiriman</td>
								</tr>
								<tr>
								<td style="width: 148px;">{{$sales->Customers->Terms->name}}</td>
								<td style="width: 148px;">{{date("d F Y",strtotime($sales->delivery_date)) }}</td>
								</tr>
								<tr>
	...
	<table style="height: 41px; border-color: #000000;" border="1" width="540">
		<tbody>
			<tr>
				...
				<td style="width: 70px;background:#4B77BE;color:#ffffff;">HARGA PER UNIT</td>
			...
			@endforeach
			<tr>
				<td style="width: 101px;" colspan="5">Thank You For Your Business!</td>
				<td style="width: 102px;" colspan="2">PPN(10%) Rp {{ number_format($sales->tax,0,',','.')}}
					<br>
					TOTAL Rp {{ number_format($sales->total,0,',','.')}}
				</td>
			</tr>
		</tbody>
	</table>
