                    ...
                    <div class="tiles"> 
                    	...
                    	<div class="tile double bg-blue-madison">
                            ...
                            <div class="tile-object">
                                <div class="number">
                                    <a href="{{ route('supplier.create') }}"><button id="sample_editable_1_new" class="btn btn-default">View</button></a>
                                    <a href="{{ route('supplier.edit',$val->id) }}"><button id="sample_editable_1_new" class="btn btn-default">Edit</button></a>
                                    <a href="{{ route('supplier.destroy',$val->id) }}"><button id="sample_editable_1_new" class="btn btn-default">Delete</button></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
