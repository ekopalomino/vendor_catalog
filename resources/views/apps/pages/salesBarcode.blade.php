		...
		<div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-database"></i>Sales Barcode 
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a href="{{ route('salesbarcode.pdf') }}"><button id="sample_editable_1_new" class="btn red btn-outline sbold">Print Barcode</button></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tiles"> 
                    	...
                    	<div class="tile double bg-white-madison">
                            <div class="tile-body">
                                ...
                                <p> <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($val->id, 'C39+')}}" alt="barcode" /> </p>   
                            </div>
                        </div>
                        @endforeach
                    </div>
