    ...
    <div class="portlet box red ">
        ...
        <div class="portlet-body form">
            <div class="m-heading-1 border-red m-bordered">
                ...
                <p> Pilih <strong>Nomor Purchase Order</strong> untuk full delivery atau <strong>Nomor Delivery Order</strong> untuk partial delivery</p>
            </div>
            @if (count($errors) > 0) 
