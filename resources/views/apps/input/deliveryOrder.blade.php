            	...
            	<div class="row">
            		<div class="col-md-5">
            			<div class="form-group">
            				...
            				{!! Form::select('customers', [null=>'Please Select'] + $customers,[], array('class' => 'form-control')) !!}
            			</div>
            		</div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('delivery_cost', null, array('placeholder' => 'Customer ID','class' => 'form-control')) !!}
                        </div>
                    </div>
            		<!--/span-->
            	</div>            		
